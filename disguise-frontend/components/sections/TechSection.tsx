...
const techCards = [
  {
    ...
    subtitle: 'InceptionResNetV1',
    description: 'Pretrained pada VGGFace2 dengan 3.31M gambar dari 9,131 identitas. Fine-tuned untuk kondisi oklusi.',
    details: ['VGGFace2 Pretrained', 'Fine-tuned Occluded', 'Multi-angle robust'],
    metric: '512',
    metricLabel: 'dim embedding',
    color: '#0097B2',
    icon: faBrain,
  },
  {
    title: 'TRAINING STRATEGY',
    subtitle: 'Batch-Hard Triplet Loss',
    description: 'Negative mining yang agresif memaksa model belajar batas keputusan yang lebih tajam dan tahan oklusi.',
    details: ['Hard Negative Mining', 'Cosine Similarity', 'Threshold: 0.57'],
    metric: '0.57',
    metricLabel: 'optimal threshold',
    color: '#FF6B35',
    icon: faBolt,
  },
  {
    ...
    description: 'HNSW indexing memungkinkan pencarian approximate nearest neighbor dalam milidetik bahkan dengan jutaan embedding.',
    details: ['HNSW Index', 'ANN Search', 'Horizontal scalable'],
    metric: '~5ms',
